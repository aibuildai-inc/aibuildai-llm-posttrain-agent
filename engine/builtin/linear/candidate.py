...
from engine.builtin.linear.agents.aggregator.io import AggregatorInput
from engine.builtin.linear.agents.worker.agent import WorkerAgent
from engine.builtin.linear.agents.worker.io import WorkerInput
...
class Ensemble(Composite[EnsembleInput]):
    """One bounded combination of the chain's already scored candidates."""
