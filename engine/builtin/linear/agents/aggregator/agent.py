"""AggregatorAgent -- builds one more design by ensembling the linear chain's graded ones.
...
from engine.builtin.linear.agents.aggregator.io import AggregatorInput, AggregatorOutput
