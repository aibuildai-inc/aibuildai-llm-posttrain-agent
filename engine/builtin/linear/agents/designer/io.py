"""Input and Output records for the linear package's Designer."""
...
class DesignerInput(AgentInput):
    # None means the user left the count to the Designer. LinearSearch always
    # forces exactly 1.
